...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if dry_run:
            print("Expired messages qty: {}".format(archive_info['exp_messages']))
            print("Expired user messages qty: {}".format(archive_info['exp_user_messages']))
            print("Expired attachemnts qty: {}".format(archive_info['exp_attachments']))
            print("Expired attachemnts messages qty: {}".format(
                archive_info['exp_attachments_messages']))
