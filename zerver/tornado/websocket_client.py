...
class WebsocketClient(object):
    def __init__(self, host_url, auth_email, run_on_start, queue_id, websocket_auth_data=None,
                 api_key=None, validate_ssl=True, **run_kwargs):
        # type: (str, str, Callable,str, Dict[str, str], Optional[str], bool, **Any) -> None
        r"""
